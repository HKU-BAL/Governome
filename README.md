...
For the sake of demonstration, the parameters used here are highly insecure. If you wish to use secure parameters, please add the statement -Toy=false. If you have executed b in {Upload a SegKey and generating a proof}, you may also choose to add -ReadKey and -Verify to read and verify the proofs from a file.
